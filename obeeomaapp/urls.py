...
from obeeomaapp.views import (
    ...
    AvatarProfileView,
    MoodTrackingView,
    SelfHelpResourceView,
    CrisisTriggerView,
    NotificationView,
    EngagementTrackerView,
    FeedbackView,
    ChatSessionView,
    ChatMessageView,
    ...
    SettingsViewSet,
    JournalEntryViewSet,
    UpdatePaymentMethodViewSet,
    PSS10AssessmentViewSet,
    ...
    VerifyInvitationOTPView,
    EngagementLevelViewSet,
    CompanyMoodViewSet,
    WellnessGraphViewSet,
    EmployeeManagementViewSet,
    NotificationViewSet,
    InviteView,
    VerifyMFAPasswordView,
    ToggleMFAView,
    AdminSubscriptionManagementViewSet,
    AdminBillingHistoryViewSet,
    EmployeeEngagementSummaryView,
...
# API routers
router.register(
    r"assessments/pss10", PSS10AssessmentViewSet, basename="pss10-assessment"
)
router.register(
    r"payment-methods", UpdatePaymentMethodViewSet, basename="payment-method"
)
...
router.register(
    r"resources/self-help", SelfHelpResourceView, basename="self-help-resources"
)
router.register(
    r"resources/educational",
    EducationalResourceViewSet,
    basename="educational-resources",
)
...
router.register(
    r"employee/engagement", EngagementTrackerView, basename="engagement-tracker"
)
...
router.register(
    r"employee/recommendations", RecommendationLogView, basename="recommendation-log"
)

router.register(
    r"dashboard/organization-overview",
    OrganizationOverviewView,
    basename="organization-overview",
)
router.register(
    r"dashboard/employees", EmployeeManagementView, basename="employee-management"
)
router.register(
    r"dashboard/departments", DepartmentManagementView, basename="department-management"
)
router.register(
    r"dashboard/subscriptions",
    SubscriptionManagementView,
    basename="subscription-management",
)
router.register(
    r"dashboard/wellness-reports", WellnessReportsView, basename="wellness-reports"
)
router.register(
    r"dashboard/settings", OrganizationSettingsView, basename="organization-settings"
)
router.register(r"dashboard/tests-by-type", TestsByTypeView, basename="tests-by-type")
router.register(
    r"dashboard/tests-by-department",
    TestsByDepartmentView,
    basename="tests-by-department",
)
...
router.register(
    r"admin/overview", SystemAdminOverviewView, basename="system-admin-overview"
)
router.register(
    r"admin/organizations",
    OrganizationsManagementView,
    basename="organizations-management",
)
router.register(
    r"admin/hotline-activity", HotlineActivityView, basename="hotline-activity"
)
router.register(r"admin/ai-management", AIManagementView, basename="ai-management")
router.register(
    r"admin/client-engagement", ClientEngagementView, basename="client-engagement"
)
router.register(
    r"admin/reports-analytics", ReportsAnalyticsView, basename="reports-analytics"
)
router.register(
    r"admin/system-settings", SystemSettingsView, basename="system-settings"
)
router.register(r"admin/feature-flags", FeaturesUsageView, basename="feature-flags")
router.register(
    r"dynamic-questions", DynamicQuestionViewSet, basename="dynamic-question"
)
# ADMIN USER MANAGEMENT ROUTERS
router.register(
    r"admin/organizations", OrganizationViewSet, basename="admin-organizations"
)
...
router.register(
    r"dashboard/billing/verify-payment", BillingView, basename="verify-payment"
)

# Assessment Questionnaires (PHQ-9 & GAD-7)
router.register(
    r"assessments/questions", AssessmentQuestionViewSet, basename="assessment-question"
)
router.register(
    r"assessments/responses", AssessmentResponseViewSet, basename="assessment-response"
)
...
router.register(
    r"employee-management", EmployeeManagementViewSet, basename="employee-mgmt"
)
router.register(r"notifications", NotificationViewSet, basename="notification-list")
router.register(
    r"organization-signup", OrganizationSignupView, basename="organization-signup"
)
urlpatterns = [
    # Content management
    path(
        "content/presign/", PresignUploadView.as_view(), name="content-presign-upload"
    ),
    path(
        "content/confirm-upload/",
        ConfirmUploadView.as_view(),
        name="content-confirm-upload",
    ),
    # Home
    path("", home, name="home"),
    # Debug endpoints
    ...
    path(
        ...
        ResetPasswordCompleteView.as_view({"post": "create"}),
    ...
    path(
        ...
        VerifyInvitationOTPView.as_view(),
        name="verify-invitation-otp",
    ),
    # Onboarding
    path(
    ...
    path(
        "auth/mfa/verify-password/",
        VerifyMFAPasswordView.as_view(),
        name="verify-mfa-password",
    ),
    ...
    path(
        "auth/organizations/<int:org_id>/details/",
        OrganizationDetailView.as_view(),
        name="organization-details",
    ),
    path(
        "auth/invitations/",
        InviteView.as_view({"post": "create", "get": "list"}),
        name="invitation",
    ),
    ...
    path(
        ...
        views.verify_payment_and_activate_subscription,
        name="verify-payment-activate",
    ),
    path(
        "billing/flutterwave-webhook/",
        views.flutterwave_webhook_listener,
    ...
    path(
        "dashboard/employee-engagement/summary/",
        EmployeeEngagementSummaryView.as_view(),
    ...
    path(
        ...
        FeaturesUsageView.as_view({"get": "list"}),
        name="features-usage",
    ),
    path(
        "dashboard/billing/",
        BillingView.as_view({"get": "list", "post": "create"}),
        name="billing",
    ),
    path(
        "dashboard/users/",
    ...
    path(
        "dashboard/subscriptions/billing-history/",
    ...
    path(
        ...
        OrganizationsManagementView.as_view({"get": "growth_chart"}),
        name="organizations-growth-chart",
    ),
    path(
        "admin/organizations/client-distribution/",
        OrganizationsManagementView.as_view({"get": "client_distribution"}),
        name="organizations-client-distribution",
    ),
    path(
        "admin/organizations/search-by-name/",
        OrganizationsManagementView.as_view({"get": "search_by_name"}),
        name="organizations-search-by-name",
    ),
    path(
        "admin/feature-flags/by-category/",
        FeaturesUsageView.as_view({"get": "by_category"}),
        name="feature-flags-by-category",
    ),
    # Employee endpoints
    path(
        "employee/profile/",
        EmployeeProfileView.as_view({"get": "list", "post": "create"}),
        name="employee-profile",
    ),
    path(
        "employee/avatar/",
        AvatarProfileView.as_view({"get": "list", "post": "create"}),
        name="avatar-profile",
    ),
    path(
        "resources/self-help/",
        SelfHelpResourceView.as_view({"get": "list", "post": "create"}),
    ...
    path(
        "employee/crisis/",
        CrisisTriggerView.as_view({"get": "list", "post": "create"}),
        name="crisis-trigger",
    ),
    path(
        "employee/notifications/",
        NotificationView.as_view({"get": "list", "post": "create"}),
        name="notifications",
    ),
    path(
        "employee/engagement/",
        EngagementTrackerView.as_view({"get": "list", "post": "create"}),
        name="engagement-tracker",
    ),
    path(
        "employee/feedback/",
        FeedbackView.as_view({"get": "list", "post": "create"}),
        name="feedback",
    ),
    path(
        "sana/sessions/",
        ChatSessionView.as_view({"get": "list", "post": "create"}),
        name="chat-sessions",
    ),
    path(
        "sana/sessions/<int:session_id>/messages/",
        ChatMessageView.as_view({"get": "list", "post": "create"}),
        name="chat-messages",
    ),
    path(
        "employee/recommendations/",
        RecommendationLogView.as_view({"get": "list", "post": "create"}),
