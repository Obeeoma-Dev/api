...
urlpatterns = [
    ...
    path("dashboard/client-engagement/", ClientEngagementView.as_view({'get': 'list'}), name="client-engagement"),
    path("dashboard/features-usage/", FeaturesUsageView.as_view({'get': 'list'}), name="features-usage"),
    path("dashboard/billing/", BillingView.as_view({'get': 'list'}), name="billing"),
    path("dashboard/invites/", InviteView.as_view({'get': 'list'}), name="invites"),
    path("dashboard/users/", UsersView.as_view({'get': 'list'}), name="users"),
    path("dashboard/users/<int:user_id>/", UserDetailView.as_view({'get': 'retrieve'}), name="user-detail"),
    ...
    # Employee Management
    path('employee/profile/', EmployeeProfileView.as_view({'get': 'list'}), name='employee-profile'),
    path('employee/avatar/', AvatarProfileView.as_view({'get': 'list'}), name='avatar-profile'),

    # Wellness & Mood
    path('employee/wellness/', WellnessHubView.as_view({'get': 'list'}), name='wellness-hub'),
    path('employee/mood-checkin/', MoodCheckInView.as_view({'post': 'create'}), name='mood-checkin'),

    # Assessments
    path('employee/assessments/', AssessmentResultView.as_view({'get': 'list', 'post': 'create'}), name='assessment-results'),

    # Resources
    path('resources/self-help/', SelfHelpResourceView.as_view({'get': 'list'}), name='self-help-resources'),
    path('resources/educational/', EducationalResourceView.as_view({'get': 'list'}), name='educational-resources'),

    # Crisis & Notifications
    path('employee/crisis/', CrisisTriggerView.as_view({'post': 'create'}), name='crisis-trigger'),
    path('employee/notifications/', NotificationView.as_view({'get': 'list'}), name='notifications'),

    # Engagement & Feedback
    path('employee/engagement/', EngagementTrackerView.as_view({'get': 'list'}), name='engagement-tracker'),
    path('employee/feedback/', FeedbackView.as_view({'post': 'create'}), name='feedback'),
