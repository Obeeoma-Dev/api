...
urlpatterns = [
    ...
    path(
        "employee/wellness/",
        WellnessHubView.as_view({"get": "list", "post": "create"}),
        name="wellness-hub",
    ),
    path(
        "employee/mood-checkin/",
        MoodCheckInView.as_view({"get": "list", "post": "create"}),
        name="mood-checkin",
    ),
    path(
        "employee/assessments/",
        AssessmentResultView.as_view({"get": "list", "post": "create"}),
    ...
    path(
        ...
        EducationalResourceView.as_view({"get": "list", "post": "create"}),
    ...
    path(
        "auth/accept-invite/",
        InvitationAcceptView.as_view({"post": "create"}),
        name="accept-invite",
    ),
    # Include router URLs
    path("", include(router.urls)),
