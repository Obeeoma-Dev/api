...
class LoginView(APIView):
    ...
    def post(self, request):
        ...
        # Onboarding required ONLY for employees who are not superusers
        if (
            user.role == "employee"
...
class InviteView(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            otp_expiry = invitation.otp_expires_at.strftime("%B %d, %Y at %I:%M %p")
    ...
    def perform_create(self, serializer):
        ...
        try:
            response = requests.post(
                AI_API_URL, headers=headers, json=payload, timeout=60
            )
