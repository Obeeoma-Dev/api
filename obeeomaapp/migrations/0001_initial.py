    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "assessment_type",
                    models.CharField(
                        choices=[("PHQ-9", "PHQ-9"), ("GAD-7", "GAD-7")], max_length=10
                    ),
                ),
                (
                    "responses",
                    models.JSONField(help_text="Array of scores for each question"),
                ),
                ("total_score", models.PositiveIntegerField()),
                ("severity_level", models.CharField(max_length=50)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('achievement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='obeeomaapp.achievement')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
