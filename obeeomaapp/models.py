...
class User(AbstractUser):
    ...
    email = models.EmailField(
        blank=True, default=""
    )  # Override AbstractUser's email to make it optional
    ...
    def get_otpauth_url(self):
        ...
        return pyotp.totp.TOTP(secret).provisioning_uri(
            name=self.username, issuer_name="ObeeomaApp"
        )
...
class EmployeeProfile(models.Model):
    ...
    subscription_tier = models.CharField(
        max_length=20, choices=[("freemium", "Freemium"), ("premium", "Premium")]
    )
...
class Article(models.Model):
    title = models.CharField(max_length=200)
    content = models.TextField()
    excerpt = models.TextField(blank=True, null=True)  # NEW
